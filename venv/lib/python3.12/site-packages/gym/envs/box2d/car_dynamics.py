...
class Car:
    ...
    def step(self, dt):
        for w in self.wheels:
            ...
            w.joint.motorSpeed = float(np.float32(dir * min(50.0 * val, 3.0)))
            ...
            # Create the b2Vec2 object for the force vector
            force_vector = b2Vec2(p_force * side[0] + f_force * forw[0], p_force * side[1] + f_force * forw[1])

            w.ApplyForceToCenter(force_vector, True)
